...
import in.indupriya.authify.io.AuthResponse;
import in.indupriya.authify.io.ResetPasswordRequest;
...
public class AuthController {
    ...
    public void verifyEmail(@RequestBody Map<String, Object> request, @CurrentSecurityContext(expression = "authentication?.name") String email){
        if(request.get("otp").toString()==null) throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Missing details");
        try{
