...
public class EmailService {
    ...
    public void sendWelcomeEmail(String toEmail, String name){
        ...
        message.setSubject("Welcome To Induopia World");
...
//        message.setText("Your OTP for resetting your password is: "+otp+". Use this OTP to proceed for resetting your password.");
//        mailSender.send(message);
//    }
//
